...
UCSD professors are conducting research studies to better understand how
students learn programming and data science — and how AI tools might be helpful
(or not!) in that learning process. The AI Tutor for this course is a part of this research, 
and the researchers are interested in studying your use of the tool. 

Your participation in this research is **completely optional**. You may **opt out at any time**,
and **opting out will not affect your grade in this course in any way**. By
participating in the research, you can help contribute to our understanding of
how to best support students learning programming and data science.

### What participation might involve

Participation may include one or more of the following:

- Allowing researchers to analyze de-identified course artifacts (e.g.,
  assignment submissions, code snapshots, or interaction logs).
- Completing pre- and post-course knowledge assessments. 
...
- Participation is opt-in and not required for the course.
- You can decline to participate or withdraw at any point by filling out this short [opt-out
form](https://docs.google.com/forms/d/e/1FAIpQLScOp3RjauMojvslcLmH87tF6O0RSx9vTXtkYpxv8LQWq6bwQA/viewform).
- Choosing not to participate (or withdrawing at any time) will not change your access
  to course resources or support, and will not impact your grade.
